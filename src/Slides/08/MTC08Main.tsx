        ...
        <Box className="w-full text-left">
          ...
          <Typography ref={body}>
            <span className="text-purple text-left font-medium">
              ...
              quibusdam aut consectetur itaque recusandae officia laborum
              deserunt facere rem animi blanditiis? Laborum iste adipisci
              asperiores nam, distinctio laboriosam hic numquam.
            </span>
          </Typography>
        </Box>
        <Stack
