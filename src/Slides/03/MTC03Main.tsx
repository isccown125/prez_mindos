...
import useVolume from "../../hooks/useVolume.tsx";
import useCutscenes from "../../hooks/useCutscenes.tsx";
...
const MTC03Main = () => {
  ...
  const { currentPath, togglePlay } = useVolume(
    audioRef,
    getAbsolutePath().coreUrl + "/assets/test_song.mp3"
  );
  const { openCutscene } = useCutscenes();
  ...
  return (
    ...
    >
                ...
                openCutscene({
                  content: () => (
                    <div className="text-white">
                      ...
                      Tempore provident ducimus molestiae consectetur cumque at
                      odio soluta labore neque, nostrum laudantium! Perferendis
                      velit recusandae harum hic deleniti exercitationem laborum
                      qui.
                    </div>
                  ),
                  name: "zonglowanie",
      ...
      <Cutscene></Cutscene>
      <audio src={currentPath} ref={audioRef}></audio>
    </Slide>
  );
};
