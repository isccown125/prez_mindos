...
const MTC18Main = () => {
  ...
  const { animate, showContent } = useAnimate(17, 0);
        ...
        <SectionContent>
          ...
          >
            ...
            <img
              ...
              src={
                ...
                "/assets/slides/1800/efekty_icon.png"
              }
            />
          </div>
          <div
          ...
          >
            ...
            <img
              ...
              src={
                getAbsolutePath().coreUrl +
                "/assets/slides/1800/search_icon.png"
              }
            />
          </div>
          <div
          ...
          >
            ...
            <img
              className="h-[80px]"
              src={
                getAbsolutePath().coreUrl + "/assets/slides/1800/award_icon.png"
              }
            />
          </div>
          ...
          <div ref={edwart} className="absolute bottom-[-50px] right-[150px]">
            <img
              className="h-[320px]"
              src={
                getAbsolutePath().coreUrl + "/assets/slides/1800/cooledwart.png"
              }
            />
          </div>
          <IconWrapper
