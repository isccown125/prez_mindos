...
function slide_anim_0000() {
  ...
  tl4
    .from(stolik3d, 0.7, { opacity: 0, x: -120, y: 80, scale: 0.1 })
    .from(rightCol, 0.7, {
      delay: 0.2,
      opacity: 0,
      scale: 0.5,
  ...
  tlIcon3
    .from(icon3, 0.4, { opacity: 0, scale: 0.3, ease: "back.out(4)" })
...
function slide_anim_0100() {
  ...
  tl.from(message, 1.0, { opacity: 0, y: 200 }).from(message, 0.4, {
    scale: 1.3,
  });
...
function slide_anim_0500() {
  const tl = new TimelineMax({ delay: 0.2 });
  const thing1 = document.querySelector("#produktywnosc_0500");
  const thing2 = document.querySelector("#muzyka_0500");
  const thing3 = document.querySelector("#notatki_0500");
  const thing4 = document.querySelector("#kofeina_0500");
  const thing5 = document.querySelector("#woda_0500");
  tl.from(thing1, 0.3, { opacity: 0 })
    .from(thing2, 0.3, { opacity: 0 })
    .from(thing3, 0.3, { opacity: 0 })
    .from(thing4, 0.3, { opacity: 0 })
    .from(thing5, 0.3, { opacity: 0 });

  const icon1 = document.querySelector("#icon_vol_0500");
  const icon2 = document.querySelector("#icon_list_0500");
  const icon3 = document.querySelector("#icon_play_0500");
...
Reveal.on("slidechanged", (event) => {
  if (event.indexh == 0 && event.indexv == 0) {
    ...
    slide_anim_0400();
  } else if (event.indexh == 5 && event.indexv == 0) {
    slide_anim_0500();
  }
});
